    ...
    <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
      <div class="fh5co_suceefh5co_height"><img src="images/nick-karvounis-78711.jpg" alt="img"/>
        ...
        <div class="fh5co_suceefh5co_height_position_absolute_font">
          ...
          <div class=""><a href="rooms" class="fh5co_good_font"> After all is said and done, more is said than done </a></div>
        </div>
      </div>
    </div>
    <div class="col-md-6">
          ...
          <div class="fh5co_suceefh5co_height_2"><img src="images/science-578x362.jpg" alt="img"/>
            ...
            <div class="fh5co_suceefh5co_height_position_absolute_font_2">
              <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                28,2017 </a></div>
              <div class=""><a href="rooms" class="fh5co_good_font_2"> After all is said and done, <br>more is said than done </a></div>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
          <div class="fh5co_suceefh5co_height_2"><img src="images/joe-gardner-75333.jpg" alt="img"/>
            ...
            <div class="fh5co_suceefh5co_height_position_absolute_font_2">
              ...
              <div class=""><a href="rooms" class="fh5co_good_font_2"> After all is said and done... </a></div>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
          <div class="fh5co_suceefh5co_height_2"><img src="images/ryan-moreno-98837.jpg" alt="img"/>
            ...
            <div class="fh5co_suceefh5co_height_position_absolute_font_2">
              <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                28,2017 </a></div>
              <div class=""><a href="rooms"class="fh5co_good_font_2"> After all is said and done, more is said than done </a></div>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
          <div class="fh5co_suceefh5co_height_2"><img src="images/10-1-1-875x500.jpg" alt="img"/>
            ...
            <div class="fh5co_suceefh5co_height_position_absolute_font_2">
              <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                28,2017 </a></div>
              <div class=""><a href="rooms" class="fh5co_good_font_2"> After all is said and done, more is said... </a></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="item px-2">
        <div class="fh5co_latest_trading_img_position_relative">
          ...
          <div class="fh5co_latest_trading_img_position_absolute_1">
            <a href="rooms" class="text-white"> Here's a new way to take better photos for instagram </a>
    ...
    <div class="owl-carousel owl-theme" id="slider2">
      <div class="item px-2">
        <div class="fh5co_hover_news_img">
          ...
          <div>
            <a href="rooms" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
      ...
      <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
        ...
        <div class="row pb-4">
          ...
          <div class="col-md-7 animate-box">
            <a href="rooms" class="fh5co_magna py-2"> Magna aliqua ut enim ad minim veniam quis
              nostrud quis xercitation ullamco. </a> <a href="rooms" class="fh5co_mini_time py-3"> Thomson Smith -
            April 18,2016 </a>
